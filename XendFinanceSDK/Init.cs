...
namespace XendFinanceSDK
{
    //public class Init
    //{
    //    public readonly IXvaltService _xvaltService;
    //    public readonly IXvaltService _xautotService;
    //    int _chainId;
    //    string _privateKey;
    //    NETWORKS _network;
    //    Assets _assets;
    ...
    //        _assets = new Assets();
    //        _generalService = new GeneralService(_network.url, _assets, privateKey, 
                
    //            .ToString(), _web3Client);
